...
public class ParkingServiceTest {
	...
	public void testIfSlotIsNotAvailableToPark() {
		...
		VehicleDetails vehicleDetails = new VehicleDetails(1, "CAR", "1234", "BLACK", "Not Parked", LocalDateTime.now(),
				"12345");
		VehicleDetails vehicleDetails1 = new VehicleDetails(2, "BUS", "1234", "RED", "Not Parked", LocalDateTime.now(),
				"12345");
		parkingService.createParkingSlots(1);
	...
	@Test
	@Order(5)
	public void testCalculateParkingChargesForCarOrBus() {
		VehicleDetails vehicleDetails;
		Double expectedValue;
		Double actualValue;
		vehicleDetails = new VehicleDetails(1, "CAR", "1234", "RED", "Not Parked", LocalDateTime.now(), "12345");
		//if (vehicleDetails.getVehicalType().equalsIgnoreCase("CAR")) {
			expectedValue = parkingService.calculateParkingCharges(vehicleDetails);
			actualValue = 30.0;
			assertEquals(expectedValue, actualValue);
		//} 
		/*	 else if (vehicleDetails.getVehicalType().equalsIgnoreCase("BUS")) { //
			 * vehicleDetails = new VehicleDetails(1, "BUS", "1234", "RED", "Not Parked", //
			 * LocalDateTime.now(), "12345"); expectedValue =
			 * parkingService.calculateParkingCharges(vehicleDetails); actualValue = 100.0;
			 * assertEquals(expectedValue, actualValue); }
			 */
	...
	public void testCalculateParkingChargesForBus() {
		VehicleDetails vehicleDetails = new VehicleDetails(1, "BUS", "1234", "RED", "Not Parked", LocalDateTime.now(),
				"12345");
