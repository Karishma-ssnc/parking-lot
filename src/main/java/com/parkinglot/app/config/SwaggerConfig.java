package com.parkinglot.app.config;
...
public class SwaggerConfig {
	 ...
	 * .select() .apis(RequestHandlerSelectors.basePackage("com.parkinglot"))
	 ...
	 * Contact("Tech Interface",
	 * "https://www.youtube.com/channel/UCMpJ8m1w9t7EFcF9x8rs02A",
	 * "info@techinterface.com")) .build(); }
	 */
